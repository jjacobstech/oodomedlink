...
CREATE TABLE `patient_result` (
  ...
  `file_type` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_size` bigint DEFAULT NULL,
  `original_file_name` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  CONSTRAINT `patient_result_clinic_id_foreign` FOREIGN KEY (`clinic_id`) REFERENCES `clinics` (`id`) ON DELETE CASCADE,
  CONSTRAINT `patient_result_patient_id_foreign` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patients` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_patient_id_email` (`patient_id`,`email`),
  KEY `idx_full_name_patient_id` (`full_name`,`patient_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2025_10_25_192333_create_email_deliveries_table',1);
