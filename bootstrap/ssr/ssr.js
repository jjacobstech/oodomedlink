...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.vue`,
      /* @__PURE__ */ Object.assign({ "./Pages/Admin/Dashboard.vue": () => import("./assets/Dashboard-FDpPy7Ve.js"), "./Pages/Admin/Emails.vue": () => import("./assets/Emails-DaKpwdxM.js"), "./Pages/Admin/Patients.vue": () => import("./assets/Patients-BIPYwpeR.js"), "./Pages/Admin/Settings.vue": () => import("./assets/Settings-C4Xrr6ee.js"), "./Pages/Auth/Admin/ForgotPassword.vue": () => import("./assets/ForgotPassword-6FNJIQxm.js"), "./Pages/Auth/Admin/Login.vue": () => import("./assets/Login-BjwxbW4o.js"), "./Pages/Auth/Admin/Register.vue": () => import("./assets/Register-CmygHiZk.js"), "./Pages/Auth/User/ForgotPassword.vue": () => import("./assets/ForgotPassword-5-sX4mOS.js"), "./Pages/Auth/User/Login.vue": () => import("./assets/Login-z-PEiaIy.js"), "./Pages/Auth/User/Register.vue": () => import("./assets/Register-crICx6y7.js"), "./Pages/User/Dashboard.vue": () => import("./assets/Dashboard-Bk8pjZyM.js"), "./Pages/User/Emails.vue": () => import("./assets/Emails-CPn5OrVY.js"), "./Pages/User/Patients.vue": () => import("./assets/Patients-CkEkCHhX.js"), "./Pages/User/Settings.vue": () => import("./assets/Settings-vStD9xKk.js"), "./Pages/Welcome.vue": () => import("./assets/Welcome-KtA3cuVC.js") })
    ),
