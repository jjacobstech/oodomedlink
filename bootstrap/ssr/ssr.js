...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.vue`,
      /* @__PURE__ */ Object.assign({ "./Pages/Admin/Dashboard.vue": () => import("./assets/Dashboard-C8pEAf-8.js"), "./Pages/Auth/Admin/ForgotPassword.vue": () => import("./assets/ForgotPassword-B_EPNp1j.js"), "./Pages/Auth/Admin/Login.vue": () => import("./assets/Login-D8o0s53F.js"), "./Pages/Auth/Admin/Register.vue": () => import("./assets/Register-DFk3OdDn.js"), "./Pages/Auth/User/ForgotPassword.vue": () => import("./assets/ForgotPassword-BHrnXW12.js"), "./Pages/Auth/User/Login.vue": () => import("./assets/Login-DjnaLqqc.js"), "./Pages/Auth/User/Register.vue": () => import("./assets/Register-B_r2jmAo.js"), "./Pages/Blog.vue": () => import("./assets/Blog-xIpId8i0.js"), "./Pages/FAQ.vue": () => import("./assets/FAQ-Csf1NLr1.js"), "./Pages/TermsAndConditions.vue": () => import("./assets/TermsAndConditions-BJTU2YHb.js"), "./Pages/User/Dashboard.vue": () => import("./assets/Dashboard-C8UDuCnc.js"), "./Pages/User/Emails.vue": () => import("./assets/Emails-B2zzm8g5.js"), "./Pages/User/Patient.vue": () => import("./assets/Patient-Dv2i_0rc.js"), "./Pages/User/Patients.vue": () => import("./assets/Patients-D58DcayT.js"), "./Pages/User/Settings.vue": () => import("./assets/Settings-Ctug960M.js"), "./Pages/Welcome.vue": () => import("./assets/Welcome-BODaqCbs.js") })
    ),
