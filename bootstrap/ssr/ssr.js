...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.vue`,
      /* @__PURE__ */ Object.assign({ "./Pages/Admin/Dashboard.vue": () => import("./assets/Dashboard-FDpPy7Ve.js"), "./Pages/Admin/Emails.vue": () => import("./assets/Emails-D-5x_sqr.js"), "./Pages/Admin/Patients.vue": () => import("./assets/Patients-CTI6EjY-.js"), "./Pages/Admin/Settings.vue": () => import("./assets/Settings-BEHcJhS9.js"), "./Pages/Auth/Admin/ForgotPassword.vue": () => import("./assets/ForgotPassword-6FNJIQxm.js"), "./Pages/Auth/Admin/Login.vue": () => import("./assets/Login-BjwxbW4o.js"), "./Pages/Auth/Admin/Register.vue": () => import("./assets/Register-CmygHiZk.js"), "./Pages/Auth/User/ForgotPassword.vue": () => import("./assets/ForgotPassword-C64Pdy3s.js"), "./Pages/Auth/User/Login.vue": () => import("./assets/Login-BfkHYUdQ.js"), "./Pages/Auth/User/Register.vue": () => import("./assets/Register-BoCQObYg.js"), "./Pages/User/Dashboard.vue": () => import("./assets/Dashboard-B0lVnVkB.js"), "./Pages/User/Emails.vue": () => import("./assets/Emails-BeGAqtKM.js"), "./Pages/User/Patients.vue": () => import("./assets/Patients-qNPf4l6c.js"), "./Pages/User/Settings.vue": () => import("./assets/Settings-2qTEeu2O.js"), "./Pages/Welcome.vue": () => import("./assets/Welcome-KtA3cuVC.js") })
    ),
