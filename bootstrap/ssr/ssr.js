...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.vue`,
      /* @__PURE__ */ Object.assign({ "./Pages/Admin/Dashboard.vue": () => import("./assets/Dashboard-6X4j7a6E.js"), "./Pages/Admin/Emails.vue": () => import("./assets/Emails-KoiPgY21.js"), "./Pages/Admin/Patients.vue": () => import("./assets/Patients-PYGXlpv_.js"), "./Pages/Admin/Settings.vue": () => import("./assets/Settings-CnX-qzD1.js"), "./Pages/Auth/Admin/ForgotPassword.vue": () => import("./assets/ForgotPassword-6FNJIQxm.js"), "./Pages/Auth/Admin/Login.vue": () => import("./assets/Login-BjwxbW4o.js"), "./Pages/Auth/Admin/Register.vue": () => import("./assets/Register-CmygHiZk.js"), "./Pages/Auth/User/ForgotPassword.vue": () => import("./assets/ForgotPassword-5-sX4mOS.js"), "./Pages/Auth/User/Login.vue": () => import("./assets/Login-z-PEiaIy.js"), "./Pages/Auth/User/Register.vue": () => import("./assets/Register-crICx6y7.js"), "./Pages/User/Dashboard.vue": () => import("./assets/Dashboard-BOpD4b6z.js"), "./Pages/User/Emails.vue": () => import("./assets/Emails-CRam4n_J.js"), "./Pages/User/Patients.vue": () => import("./assets/Patients-Cv0IGJwi.js"), "./Pages/User/Settings.vue": () => import("./assets/Settings-Tg_EkyNU.js"), "./Pages/Welcome.vue": () => import("./assets/Welcome-KtA3cuVC.js") })
    ),
