...
import { ssrRenderComponent, ssrRenderList, ssrRenderVNode, ssrInterpolate, ssrRenderSlot, ssrRenderAttrs, ssrIncludeBooleanAttr } from "vue/server-renderer";
import { _ as _sfc_main$i, a as _sfc_main$j, b as _sfc_main$l, c as _sfc_main$m, d as _sfc_main$n, e as _sfc_main$o, f as _sfc_main$p, g as _sfc_main$r, h as _sfc_main$s, j as _sfc_main$t, i as _sfc_main$u } from "./index-tVDjCcDH.js";
...
import { _ as _sfc_main$q } from "./index-CyWCJ_Mb.js";
...
const Notifications = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-d327275c"]]);
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$s), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$u), { class: "flex h-16 w-16 items-center justify-center rounded-full bg-white text-xl font-extrabold text-primaryDark" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                  ...
                  return [
                    ...
                    createVNode(unref(_sfc_main$u), { class: "flex h-16 w-16 items-center justify-center rounded-full bg-white text-xl font-extrabold text-primaryDark" }, {
                      default: withCtx(() => [
                        createVNode("p", { class: "bg-deepgradient bg-clip-text" }, toDisplayString(unref(auth).user.name.charAt(0).toUpperCase()), 1)
                      ]),
                      _: 1
