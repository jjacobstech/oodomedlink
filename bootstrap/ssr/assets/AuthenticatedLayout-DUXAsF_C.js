...
import { _ as _sfc_main$j, a as _sfc_main$k, b as _sfc_main$m, c as _sfc_main$n, d as _sfc_main$o, e as _sfc_main$p, f as _sfc_main$q, g as _sfc_main$s, h as _sfc_main$t, j as _sfc_main$u, i as _sfc_main$v } from "./index-DVie8IsK.js";
...
import { _ as _sfc_main$l } from "./ApplicationLogo-Bxi8t0Nk.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$4), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="relative flex items-center justify-center rounded-full p-2 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800" data-v-7d6739de${_scopeId2}>`);
                  ...
                  if (unreadCount.value > 0) {
                    _push3(ssrRenderComponent(_sfc_main$3, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span class="font-bold text-white" data-v-7d6739de${_scopeId3}>${ssrInterpolate(unreadCount.value > 99 ? "99+" : unreadCount.value)}</span>`);
                        } else {
                          return [
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$f), {
              align: "start",
              class: "w-80 mr-5 max-w-[calc(100vw-2rem)] p-0 md:w-96"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$c), { class: "border-b px-4 py-3" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="flex items-center justify-between" data-v-7d6739de${_scopeId3}><h3 class="text-base font-semibold" data-v-7d6739de${_scopeId3}>Notifications</h3><div class="flex items-center gap-2" data-v-7d6739de${_scopeId3}>`);
                        ...
                        if (unreadCount.value > 0) {
                          _push4(`<button${ssrIncludeBooleanAttr(isProcessing.value === "all") ? " disabled" : ""} class="text-xs text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 disabled:opacity-50 disabled:cursor-not-allowed" type="button" data-v-7d6739de${_scopeId3}>${ssrInterpolate(isProcessing.value === "all" ? "Marking..." : "Mark all read")}</button>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(`</div></div>`);
                  ...
                  _push3(`<div class="max-h-[60vh] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent" role="list" data-v-7d6739de${_scopeId2}>`);
                  if (notifications.value.length > 0) {
                    ...
                    ssrRenderList(notifications.value, (notification) => {
                      _push3(ssrRenderComponent(unref(_sfc_main$d), {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div class="flex w-full items-start gap-3" data-v-7d6739de${_scopeId3}>`);
                            if (!notification.read_at) {
                              _push4(`<div class="mt-1.5 h-2 w-2 flex-shrink-0 rounded-full bg-blue-500" aria-label="Unread" data-v-7d6739de${_scopeId3}></div>`);
                            } else {
                              _push4(`<div class="mt-1.5 h-2 w-2 flex-shrink-0" data-v-7d6739de${_scopeId3}></div>`);
                            }
                            _push4(`<div class="flex-1 space-y-1" data-v-7d6739de${_scopeId3}><p class="text-sm leading-relaxed text-gray-900 dark:text-gray-100" data-v-7d6739de${_scopeId3}>${ssrInterpolate(notification.data.data)}</p><p class="text-xs text-gray-500 dark:text-gray-400" data-v-7d6739de${_scopeId3}>${ssrInterpolate(getNotificationTime(notification))}</p></div>`);
                            if (isProcessing.value === notification.id) {
                              _push4(`<div class="mt-1.5 flex-shrink-0" data-v-7d6739de${_scopeId3}><div class="h-4 w-4 animate-spin rounded-full border-2 border-gray-300 border-t-blue-500" data-v-7d6739de${_scopeId3}></div></div>`);
                            } else {
                              _push4(`<!---->`);
                            }
                            _push4(`</div>`);
                    ...
                    _push3(`<div class="flex flex-col items-center justify-center py-12 px-4" data-v-7d6739de${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(Bell), {
                      class: "h-12 w-12 fill-gray-300 text-gray-200 dark:fill-gray-600 dark:text-gray-700",
                      "aria-hidden": "true"
                    }, null, _parent3, _scopeId2));
                    _push3(`<p class="mt-3 text-sm text-gray-500 dark:text-gray-400" data-v-7d6739de${_scopeId2}> No notifications yet </p></div>`);
                  }
                  _push3(`</div>`);
...
const Notifications = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-7d6739de"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(_sfc_main$q), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<main class="relative h-screen w-full bg-primaryLight" data-v-9dd9a327${_scopeId}><div class="flex w-full items-center justify-between bg-primaryDark/50 p-5 md:px-10" data-v-9dd9a327${_scopeId}><div class="flex justify-start" data-v-9dd9a327${_scopeId}>`);
            ...
            _push2(`</div><div class="flex items-center w-[25%] md:w-1/2 justify-end gap-5 md:gap-12" data-v-9dd9a327${_scopeId}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$v), { class: "flex h-16 w-16 items-center justify-center rounded-full bg-white text-xl font-extrabold text-primaryDark" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p class="bg-deepgradient bg-clip-text" data-v-9dd9a327${_scopeId3}>${ssrInterpolate(unref(auth).user.name.charAt(0).toUpperCase())}</p>`);
                      } else {
                        return [
            ...
            _push2(`</div></div>`);
            ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
            _push2(`<footer class="bg-primaryLight" data-v-9dd9a327${_scopeId}><p class="text-center text-xl text-black" data-v-9dd9a327${_scopeId}> © 2025 Oodo Medlink. All Rights Reserved </p></footer></main>`);
          } else {
            return [
              createVNode(_sfc_main$r),
              createVNode(AppSidebar),
              createVNode("main", { class: "relative h-screen w-full bg-primaryLight" }, [
                createVNode("div", { class: "flex w-full items-center justify-between bg-primaryDark/50 p-5 md:px-10" }, [
                  ...
                  createVNode("div", { class: "flex items-center w-[25%] md:w-1/2 justify-end gap-5 md:gap-12" }, [
      ...
      if (!chat.value) {
        _push(`<div class="fixed bottom-10 right-5 cursor-pointer bg-primaryDark rounded-md text-center shadow-lg p-2" data-v-9dd9a327><div class="flex w-full justify-center md:px-4 items-center" data-v-9dd9a327>`);
        _push(ssrRenderComponent(unref(MessageCircleDashed), {
          size: 50,
          class: "text-white md:block hidden shadow-lg"
        }, null, _parent));
        _push(ssrRenderComponent(unref(MessageCircleDashed), {
          size: 30,
          class: "text-white shadow-lg block md:hidden"
        }, null, _parent));
        _push(`</div><p class="text-white text-md font-extrabold px-2 py-1" data-v-9dd9a327>Chat</p></div>`);
      } else {
        _push(`<!---->`);
      }
      if (chat.value) {
        _push(`<div class="fixed bottom-10 right-5 bg-white rounded-lg shadow-2xl w-80 h-96 flex flex-col" data-v-9dd9a327><div class="flex justify-between p-4 rounded-t-lg bg-primaryDark items-center" data-v-9dd9a327><div class="flex gap-2 items-center" data-v-9dd9a327><div class="w-10 h-10 flex items-center justify-center rounded-full bg-white text-primaryDark" data-v-9dd9a327>`);
        _push(ssrRenderComponent(unref(Bot), { class: "w-6 h-6" }, null, _parent));
        _push(`</div><div class="grid" data-v-9dd9a327><h1 class="text-md font-bold text-white" data-v-9dd9a327>The Med Bot</h1><h1 class="text-sm items-center font-bold text-green-500" data-v-9dd9a327>Online</h1></div></div><button class="text-white transition-all duration-150 hover:bg-white rounded-full hover:text-primaryDark" data-v-9dd9a327>`);
        _push(ssrRenderComponent(unref(XCircle), { class: "w-6 h-6" }, null, _parent));
        _push(`</button></div><div class="flex-1 overflow-y-auto px-4 py-2 bg-gray-50" data-v-9dd9a327><!--[-->`);
        ssrRenderList(messages.value, (message) => {
          _push(`<h1 class="${ssrRenderClass([message.sender === "User" ? "ml-auto bg-white text-primaryDark border border-primaryDark" : "mr-auto bg-primaryDark text-white", "rounded-lg my-2 text-xs p-2 max-w-[80%]"])}" data-v-9dd9a327>${ssrInterpolate(message.text ?? "hello")}</h1>`);
        });
        _push(`<!--]-->`);
        if (loading.value) {
          _push(`<div class="flex justify-center items-center" data-v-9dd9a327>`);
        ...
        _push(`</div><div class="p-4 border-t border-gray-200 bg-white rounded-b-lg" data-v-9dd9a327><div class="flex gap-2 items-center" data-v-9dd9a327><input${ssrRenderAttr("value", newMessageText.value)} class="flex-1 rounded-md border border-primaryDark px-3 py-2 placeholder:font-medium placeholder:text-gray-700 focus:outline-none focus:ring-2 focus:ring-primaryDark" placeholder="Type a message..." data-v-9dd9a327><button class="btn text-primaryDark rounded-md py-4 px-3 flex justify-center items-center hover:bg-primaryDark hover:text-white" data-v-9dd9a327>`);
...
const AuthenticatedLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9dd9a327"]]);
export {
