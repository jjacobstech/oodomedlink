...
import { _ as _sfc_main$b } from "./ApplicationLogo-Bxi8t0Nk.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex h-screen flex-col-reverse lg:flex-row items-center justify-between gap-10 px-4 pt-20 sm:px-6 lg:px-12 2xl:px-20"${_scopeId}><div class="w-full md:w-1/2 flex items-center max-w-xl space-y-5 text-center lg:text-left lg:max-w-2xl"${_scopeId}><div${_scopeId}><h1 class="text-3xl sm:text-5xl md:text-6xl lg:text-6xl 2xl:text-8xl font-extrabold text-black leading-tight"${_scopeId}> Fast,<br${_scopeId}> Secure and<br${_scopeId}> Convenient<br${_scopeId}> Test Results </h1><p class="text-sm sm:text-lg lg:text-xl 2xl:text-2xl font-semibold text-gray-700 leading-relaxed"${_scopeId}> Your health and peace of mind should not be a gamble. Oodo Medlink gives you fast, secure and convenient access to your lab test results anytime, anywhere. </p><div class="flex flex-col sm:flex-row items-center gap-3 pt-2 w-full"${_scopeId}><input type="email" id="email-input"${ssrRenderAttr("value", email.value)} class="w-full rounded-md border border-gray-300 px-3 py-2.5 sm:px-4 sm:py-3 text-base sm:text-lg lg:text-xl font-semibold focus:ring-2 focus:ring-primaryDark focus:outline-none" placeholder="Enter your email"${_scopeId}><button class="w-full sm:w-auto whitespace-nowrap rounded-md bg-primaryDark px-5 py-2.5 sm:px-6 sm:py-3 text-base sm:text-lg lg:text-xl font-bold text-white hover:opacity-90 transition"${_scopeId}> Start Now </button></div></div></div><div class="w-full md:w-1/2 max-w-2xl mx-auto lg:w-1/2"${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$8), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$7), { class: "flex justify-center gap-2" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<!--[-->`);
                  ...
                  return [
                    createVNode(unref(_sfc_main$7), { class: "flex justify-center gap-2" }, {
                      default: withCtx(() => [
            ...
            ssrRenderList(securityFeatures.value, (item, index) => {
              _push2(`<div class="${ssrRenderClass([
                ...
                index === securityFeatures.value.length - 1 && securityFeatures.value.length % 2 !== 0 ? "md:col-span-2 md:max-w-md md:mx-auto" : ""
              ])}"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "flex h-screen flex-col-reverse lg:flex-row items-center justify-between gap-10 px-4 pt-20 sm:px-6 lg:px-12 2xl:px-20" }, [
                createVNode("div", { class: "w-full md:w-1/2 flex items-center max-w-xl space-y-5 text-center lg:text-left lg:max-w-2xl" }, [
                ...
                createVNode("div", { class: "w-full md:w-1/2 max-w-2xl mx-auto lg:w-1/2" }, [
