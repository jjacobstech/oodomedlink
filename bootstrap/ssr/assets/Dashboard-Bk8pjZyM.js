                      ...
                      createVNode("div", { class: "flex flex-col gap-3 sm:gap-4 mb-4" }, [
                        createVNode("div", { class: "flex flex-wrap gap-2 sm:gap-3" }, [
                          createVNode("button", {
                            ...
                            class: [selectedFilter.value === "all" ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-700", "px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm lg:text-base font-medium rounded-lg transition-all hover:shadow-md"]
                          }, " All ", 10, ["onClick"]),
                          createVNode("button", {
                            onClick: ($event) => filteredResults("pending"),
                            class: [selectedFilter.value === "pending" ? "bg-orange-600 text-white" : "bg-gray-200 text-gray-700", "px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm lg:text-base font-medium rounded-lg transition-all hover:shadow-md"]
                          }, " Pending ", 10, ["onClick"]),
                          createVNode("button", {
                            onClick: ($event) => filteredResults("completed"),
                            class: [selectedFilter.value === "completed" ? "bg-green-600 text-white" : "bg-gray-200 text-gray-700", "px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm lg:text-base font-medium rounded-lg transition-all hover:shadow-md"]
                          }, " Completed ", 10, ["onClick"]),
                          createVNode("button", {
                            onClick: ($event) => filteredResults("reviewed"),
                            class: [selectedFilter.value === "reviewed" ? "bg-purple-600 text-white" : "bg-gray-200 text-gray-700", "px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm lg:text-base font-medium rounded-lg transition-all hover:shadow-md"]
                          }, " Reviewed ", 10, ["onClick"])
                        ]),
                              ...
                              (openBlock(true), createBlock(Fragment, null, renderList(unref(filtered), (result) => {
                                return openBlock(), createBlock("tr", {
                                  ...
                                  createVNode("td", { class: "hidden lg:table-cell px-3 sm:px-4 lg:px-6 py-3 sm:py-4" }, [
                                    createVNode("span", { class: "flex items-center gap-2 text-xs sm:text-sm text-gray-700" }, [
                                      createVNode("span", null, toDisplayString(getFileIcon(result.file_type)), 1),
                                      createVNode("span", { class: "truncate max-w-[150px] xl:max-w-[200px]" }, toDisplayString(result.file_name), 1)
                                    ])
                                  ]),
                                  createVNode("td", { class: "hidden xl:table-cell px-3 sm:px-4 lg:px-6 py-3 sm:py-4 text-xs sm:text-sm text-gray-700" }, toDisplayString(formatDate(result.upload_date)), 1),
                                  createVNode("td", { class: "px-3 sm:px-4 lg:px-6 py-3 sm:py-4" }, [
                                    createVNode("span", {
                                      class: [{
                                        "bg-orange-100 text-orange-800": result.status === "pending",
