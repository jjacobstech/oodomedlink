      ...
      _push(ssrRenderComponent(AuthLayout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="container relative z-10 mx-auto flex min-h-[calc(100vh-80px)] items-center justify-center py-12 lg:max-w-xl"${_scopeId}><div class="w-full space-y-4 px-5 lg:px-20"${_scopeId}><div class="flex justify-start"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "flex w-full justify-center overflow-hidden" }, [
                ...
                createVNode("div", { class: "container relative z-10 mx-auto flex min-h-[calc(100vh-80px)] items-center justify-center py-12 lg:max-w-xl" }, [
                  createVNode("div", { class: "w-full space-y-4 px-5 lg:px-20" }, [
