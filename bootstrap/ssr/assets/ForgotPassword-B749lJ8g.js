            ...
            if (currentStep.value === 3) {
              ...
              ssrRenderList(biodataFields.value, (field) => {
                ...
                if (field.type !== "password") {
                  _push2(`<input${ssrRenderAttr("id", field.id)}${ssrRenderAttr("type", field.type)}${ssrRenderAttr("placeholder", field.placeholder)}${ssrRenderAttr("autocomplete", field.autocomplete)}${ssrRenderDynamicModel(field.type, unref(resetForm)[field.model], null)} class="focus:ring-deepgreen w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2"${_scopeId}>`);
                } else {
