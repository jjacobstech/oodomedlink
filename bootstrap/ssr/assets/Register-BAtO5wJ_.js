import { ref, unref, withCtx, createTextVNode, createVNode, toDisplayString, createBlock, openBlock, Fragment, renderList, createCommentVNode, withModifiers, withDirectives, vModelText, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderDynamicModel } from "vue/server-renderer";
import { _ as _sfc_main$3 } from "./PasswordInput-BkOFItoK.js";
import { _ as _sfc_main$1 } from "./AdminAuthLayout-CBWg2bKK.js";
import { u as useToast, _ as _sfc_main$2 } from "./index-CyWCJ_Mb.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="${ssrRenderClass(currentStep.value !== 3 ? "block" : "hidden")}">`);
