      ...
      try {
        emailForm.post(route("send.otp"), {
          ...
          onError: (error) => {
            toast({
              title: "Error",
              description: error.email ?? error ?? "Failed to send verification code",
              variant: "destructive",
              class: "text-primaryDark bg-white shadow-lg"
            });
          }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(AuthLayout, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container relative z-10 mx-auto flex min-h-[calc(100vh-80px)] items-center justify-center py-12 lg:max-w-xl"${_scopeId}><div class="w-full space-y-4 px-7 lg:px-5"${_scopeId}>`);
            ...
            _push2(`<div class="grid items-center rounded-xl bg-white shadow-xl"${_scopeId}><div class="grid space-y-1 rounded-t-lg w-full bg-primaryDark p-6"${_scopeId}><h2 class="text-center font-bold text-white lg:text-2xl"${_scopeId}> Complete Registration </h2><p class="text-center text-xl text-white"${_scopeId}> Create an account - Step ${ssrInterpolate(currentStep.value)} of 3 </p></div><div class="flex justify-center bg-white px-4 py-6 lg:px-0"${_scopeId}><div class="px-auto flex items-center justify-between"${_scopeId}><!--[-->`);
            ...
            if (currentStep.value === 2) {
              _push2(`<form class="space-y-4"${_scopeId}><div class="space-y-2 w-full"${_scopeId}><label for="otp" class="font-bold lg:text-xl"${_scopeId}>Verification Code</label><p class="mb-2 w-full text-gray-500 font-bold lg:text-md"${_scopeId}> Enter the 6-digit code sent to ${ssrInterpolate(unref(emailForm).email ?? "jacobsjoshua81@gmail.com")}</p><input id="otp" type="text" placeholder="Enter 6-digit code" maxlength="6"${ssrRenderAttr("value", unref(otpForm).otp)} class="w-full rounded-md border border-gray-300 px-3 py-2 text-center text-2xl tracking-widest focus:outline-none focus:ring-2 focus:ring-primaryDark"${_scopeId}></div><button type="submit" class="hover:shadow-primaryring-primaryDark/30 w-full rounded-lg bg-primaryDark px-4 py-2.5 font-bold text-white transition-all duration-200 hover:-translate-y-1 hover:bg-white hover:text-primaryDark hover:shadow-md disabled:cursor-not-allowed disabled:opacity-50 lg:text-xl"${ssrIncludeBooleanAttr(isLoading.value) ? " disabled" : ""}${_scopeId}>${ssrInterpolate(isLoading.value ? "Verifying..." : "Verify Code")}</button><div class="mt-4 text-center"${_scopeId}><button type="button" class="text-primary ring-primaryDark ring-primaryDark/80 transition-colors hover:text-primary lg:text-xl"${ssrIncludeBooleanAttr(isLoading.value) ? " disabled" : ""}${_scopeId}> Resend Code </button></div></form>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              createVNode("div", { class: "container relative z-10 mx-auto flex min-h-[calc(100vh-80px)] items-center justify-center py-12 lg:max-w-xl" }, [
                createVNode("div", { class: "w-full space-y-4 px-7 lg:px-5" }, [
                  ...
                  createVNode("div", { class: "grid items-center rounded-xl bg-white shadow-xl" }, [
                    createVNode("div", { class: "grid space-y-1 rounded-t-lg w-full bg-primaryDark p-6" }, [
                    ...
                    createVNode("div", { class: "space-y-4 bg-white rounded-b-lg p-6" }, [
                      ...
                      currentStep.value === 2 ? (openBlock(), createBlock("form", {
                        ...
                        createVNode("div", { class: "space-y-2 w-full" }, [
                          ...
                          createVNode("p", { class: "mb-2 w-full text-gray-500 font-bold lg:text-md" }, " Enter the 6-digit code sent to " + toDisplayString(unref(emailForm).email ?? "jacobsjoshua81@gmail.com"), 1),
                          withDirectives(createVNode("input", {
                            id: "otp",
                            type: "text",
