...
import { _ as _sfc_main$1 } from "./AdminAuthLayout-BBnUiDwO.js";
import { u as useToast, _ as _sfc_main$2, a as _sfc_main$3 } from "./PasswordInput-BRdDyhnh.js";
import "@vueuse/core";
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="h-screen overflow-y-hidden flex justify-center items-center"${_scopeId}><div class="max-w-lg justify-center rounded-xl shadow-xl bg-white items-center"${_scopeId}><div class="p-6 grid space-y-1 bg-deepgradient rounded-t-lg"${_scopeId}><h2 class="text-2xl font-bold text-center text-white"${_scopeId}>Complete Registration</h2><p class="text-center text-white"${_scopeId}> Create an account - Step ${ssrInterpolate(currentStep.value)} of 3 </p></div><div class="py-6 flex justify-center"${_scopeId}><div class="flex justify-between items-center px-auto"${_scopeId}><!--[-->`);
