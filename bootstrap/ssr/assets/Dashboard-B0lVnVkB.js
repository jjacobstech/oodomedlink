    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex w-full h-full gap-1 overflow-hidden bg-white"${_scopeId}><div class="w-full p-6 mb-16 overflow-y-scroll bg-white scrollbar-thin scrollbar-thumb-blue-500 scrollbar-track-gray-100"${_scopeId}><div class="mb-6"${_scopeId}><h1 class="text-4xl font-bold text-gray-800"${_scopeId}>Dashboard</h1><p class="text-gray-600 text-xl font-bold"${_scopeId}>Manage patient test results and uploads</p></div><div class="grid grid-cols-1 gap-4 mb-6 md:grid-cols-2 lg:grid-cols-4"${_scopeId}><!--[-->`);
            ...
            return [
              createVNode("div", { class: "flex w-full h-full gap-1 overflow-hidden bg-white" }, [
                createVNode("div", { class: "w-full p-6 mb-16 overflow-y-scroll bg-white scrollbar-thin scrollbar-thumb-blue-500 scrollbar-track-gray-100" }, [
                  ...
                  createVNode("div", { class: "p-6 mb-6 bg-white shadow-md rounded-xl" }, [
                    createVNode("div", { class: "flex items-center justify-between mb-4" }, [
                      createVNode("h2", { class: "text-2xl font-bold text-gray-800" }, "Upload Patient Results"),
                      createVNode("button", {
                    ...
                    createVNode("p", { class: "text-md font-bold text-gray-600" }, "Supported formats: PDF, Images (JPG, PNG), CSV, XLSX, XLS, DOC, DOCX files")
                  ]),
