        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="h-full w-full bg-gray-100"${_scopeId}><div class="overflow-y-scroll p-6"${_scopeId}><div class="mb-6"${_scopeId}><h1 class="text-3xl font-bold text-gray-800"${_scopeId}> Patient Emails </h1><p class="text-gray-600"${_scopeId}> Monitor and manage all sent emails to patients </p></div><div class="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between"${_scopeId}><div class="flex gap-2"${_scopeId}><button class="${ssrRenderClass([
              ...
              selectedFilter.value === "in_progress" ? "bg-orange-600 text-white" : "bg-gray-200 text-gray-700",
              "rounded-lg px-4 py-2 font-medium transition-colors"
            ])}"${_scopeId}> In Progress </button><button class="${ssrRenderClass([
              selectedFilter.value === "sent" ? "bg-green-600 text-white" : "bg-gray-200 text-gray-700",
              "rounded-lg px-4 py-2 font-medium transition-colors"
            ])}"${_scopeId}> Sent </button><button class="${ssrRenderClass([
              selectedFilter.value === "failed" ? "bg-red-600 text-white" : "bg-gray-200 text-gray-700",
              "rounded-lg px-4 py-2 font-medium transition-colors"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Emails.vue");
