...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "navbar fixed top-0 z-50 flex w-full items-center bg-white px-4 py-3 shadow-md md:px-8 lg:px-12" }, _attrs))}><div class="flex w-full items-center justify-between">`);
