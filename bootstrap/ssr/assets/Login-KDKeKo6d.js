...
import { _ as _sfc_main$2 } from "./AdminAuthLayout-tgL6Td7e.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-full overflow-hidden"${_scopeId}><div class="container relative z-10 mx-auto flex min-h-[calc(100vh-80px)] max-w-3xl items-center justify-center px-4 py-12"${_scopeId}><div class="w-full space-y-5 px-40 py-10"${_scopeId}><div class="flex justify-start"${_scopeId}>`);
            ...
            _push2(`</div><div class="rounded-lg bg-white shadow-xl"${_scopeId}><div class="border-primaryDark bg-primaryDark space-y-1 rounded-t-lg border-b p-6"${_scopeId}><h2 class="text-center text-2xl font-bold text-white"${_scopeId}> Admin </h2><p class="text-center text-lg text-white"${_scopeId}> Enter your email address and password </p></div><div class="p-6"${_scopeId}><form class="space-y-5"${_scopeId}><div class="space-y-2"${_scopeId}><label for="login-email" class="block text-lg font-extrabold text-gray-600"${_scopeId}> Email </label><input id="login-email"${ssrRenderAttr("value", unref(loginForm).email)} type="email" placeholder="Enter your email" class="focus:ring-primaryDark w-full rounded-lg border border-gray-300 px-4 py-2.5 transition-all focus:border-transparent focus:outline-none focus:ring-2" required${_scopeId}></div><div class="space-y-2"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><label for="login-password" class="block text-lg font-extrabold text-gray-600"${_scopeId}> Password </label>`);
            _push2(ssrRenderComponent(unref(Link), {
            ...
            _push2(`</div><button type="submit" class="bg-primaryDark hover:shadow-primaryDark/30 group w-full rounded-lg px-4 py-2.5 font-extrabold text-lg text-white transition-all duration-200 hover:-translate-y-1 hover:bg-white hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-50"${ssrIncludeBooleanAttr(isLoading.value) ? " disabled" : ""}${_scopeId}><p class="group-hover:bg-primaryDark group-hover:bg-clip-text group-hover:text-transparent"${_scopeId}>${ssrInterpolate(isLoading.value ? "Logging in..." : "Log in")}</p></button></form><div class="mt-6 text-center"${_scopeId}><p class="text-lg font-bold text-gray-600"${_scopeId}> New here? `);
            _push2(ssrRenderComponent(unref(Link), {
            ...
            return [
              createVNode("div", { class: "w-full overflow-hidden" }, [
                createVNode("div", { class: "container relative z-10 mx-auto flex min-h-[calc(100vh-80px)] max-w-3xl items-center justify-center px-4 py-12" }, [
                  createVNode("div", { class: "w-full space-y-5 px-40 py-10" }, [
                    ...
                    createVNode("div", { class: "rounded-lg bg-white shadow-xl" }, [
                      createVNode("div", { class: "border-primaryDark bg-primaryDark space-y-1 rounded-t-lg border-b p-6" }, [
                      ...
                      createVNode("div", { class: "p-6" }, [
                        createVNode("form", {
                          ...
                          createVNode("div", { class: "space-y-2" }, [
                            createVNode("label", {
                              for: "login-email",
                              class: "block text-lg font-extrabold text-gray-600"
                            }, " Email "),
                        ...
                        createVNode("div", { class: "mt-6 text-center" }, [
                          createVNode("p", { class: "text-lg font-bold text-gray-600" }, [
