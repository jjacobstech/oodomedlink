    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(_sfc_main$2), mergeProps({ class: "bg-primaryDark" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$3), { class: "flex py-4 sm:py-5 lg:py-7 bg-primaryDark items-center justify-between backdrop-blur-sm" }, {
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$5), { class: "py-3 sm:py-4 bg-primaryDark" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                      ...
                      if (_push4) {
                        ...
                        ssrRenderList(menuItems, (item) => {
                          ...
                          if (isActive(item.href)) {
                            _push4(ssrRenderComponent(unref(_sfc_main$7), { class: "bg-primaryLight text-primaryDark relative overflow-hidden group" }, {
                            ...
                            _push4(ssrRenderComponent(unref(_sfc_main$7), { class: "hover:bg-primaryLight text-white hover:text-primaryDark relative overflow-hidden group" }, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(ssrRenderComponent(unref(Link), {
                                    href: item.href,
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$8), { class: "p-2 sm:p-3 bg-primaryDark backdrop-blur-sm" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$7), { class: "group hover:bg-red-50 dark:hover:bg-red-950/20 transition-all duration-300 rounded-lg" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                  ...
                  return [
                    createVNode(unref(_sfc_main$7), { class: "group hover:bg-red-50 dark:hover:bg-red-950/20 transition-all duration-300 rounded-lg" }, {
                      default: withCtx(() => [
                        createVNode("a", {
                          onClick: logout,
                          class: "flex items-center gap-2 sm:gap-3 w-full px-3 sm:px-4 py-2 sm:py-2.5 lg:py-3 cursor-pointer transition-colors duration-300"
            ...
            return [
              createVNode(unref(_sfc_main$3), { class: "flex py-4 sm:py-5 lg:py-7 bg-primaryDark items-center justify-between backdrop-blur-sm" }, {
                default: withCtx(() => [
                  createVNode("div", { class: "transform rounded-lg sm:rounded-xl p-1.5 sm:p-2 transition-transform duration-300 hover:scale-105 bg-white" }, [
                    createVNode(_sfc_main$4)
                  ])
              ...
              createVNode(unref(_sfc_main$5), { class: "py-3 sm:py-4 bg-primaryDark" }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$6), { class: "space-y-2 sm:space-y-3 lg:space-y-4" }, {
                    default: withCtx(() => [
                      (openBlock(), createBlock(Fragment, null, renderList(menuItems, (item) => {
              ...
              createVNode(unref(_sfc_main$8), { class: "p-2 sm:p-3 bg-primaryDark backdrop-blur-sm" }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$7), { class: "group hover:bg-red-50 dark:hover:bg-red-950/20 transition-all duration-300 rounded-lg" }, {
                    default: withCtx(() => [
                      createVNode("a", {
...
const AppSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-c44c2fd2"]]);
