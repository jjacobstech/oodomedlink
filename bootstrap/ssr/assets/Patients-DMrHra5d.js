    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="h-full w-full bg-gray-100"${_scopeId}><div class="overflow-y-scroll p-6"${_scopeId}><div class="mb-6"${_scopeId}><h1 class="text-3xl font-bold text-gray-800"${_scopeId}> Patients Management </h1><p class="text-gray-600"${_scopeId}> View and manage all registered patients and their test results </p></div><div class="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between"${_scopeId}><div class="flex gap-2"${_scopeId}><button class="${ssrRenderClass([
            ...
            ssrRenderList(filteredPatients.value, (patient) => {
              _push2(`<tr class="hover:bg-gray-50"${_scopeId}><td class="px-4 py-3 font-medium text-gray-800"${_scopeId}>${ssrInterpolate(patient.name)}</td><td class="px-4 py-3 text-gray-700"${_scopeId}>${ssrInterpolate(patient.email)}</td><td class="px-4 py-3 text-gray-700"${_scopeId}>${ssrInterpolate(patient.phone)}</td><td class="px-4 py-3 text-gray-700"${_scopeId}>${ssrInterpolate(patient.gender)}</td><td class="px-4 py-3 text-gray-700"${_scopeId}>${ssrInterpolate(formatDate(patient.date_of_birth))}</td><td class="px-4 py-3 text-center text-gray-700"${_scopeId}>${ssrInterpolate(patient.total_results)}</td><td class="px-4 py-3 text-gray-600"${_scopeId}>${ssrInterpolate(formatDate(patient.last_result_date))}</td><td class="px-4 py-3"${_scopeId}><button class="rounded bg-blue-100 px-3 py-1 text-xs font-medium text-blue-700 transition hover:bg-blue-200"${_scopeId}> View Results </button></td></tr>`);
            });
            _push2(`<!--]-->`);
                      ...
                      createVNode("tbody", { class: "divide-y divide-gray-200" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(filteredPatients.value, (patient) => {
                          return openBlock(), createBlock("tr", {
                            ...
                            createVNode("td", { class: "px-4 py-3 text-center text-gray-700" }, toDisplayString(patient.total_results), 1),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Patients.vue");
