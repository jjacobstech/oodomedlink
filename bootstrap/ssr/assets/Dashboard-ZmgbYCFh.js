import { defineComponent, ref, computed, unref, withCtx, createVNode, createBlock, createCommentVNode, openBlock, toDisplayString, withDirectives, vModelText, Fragment, renderList, withModifiers, vModelSelect, useSSRContext } from "vue";
...
import { _ as _sfc_main$1 } from "./AdminAuthenticatedLayout-CrwmDkVx.js";
          ...
          if (_push2) {
            ...
            if (activeTab.value === "patients") {
              ...
              ssrRenderList(filteredPatients.value, (patient) => {
                _push2(`<tr class="hover:bg-gray-50"${_scopeId}><td class="px-4 py-4 text-sm font-medium text-gray-900"${_scopeId}>${ssrInterpolate(patient.id)}</td><td class="px-4 py-4 text-sm text-gray-700"${_scopeId}>${ssrInterpolate(patient.full_name)}</td><td class="px-4 py-4 text-sm text-gray-700"${_scopeId}>${ssrInterpolate(patient.email)}</td><td class="px-4 py-4 text-sm text-gray-700"${_scopeId}>${ssrInterpolate(patient.phone_no)}</td><td class="px-4 py-4 text-sm text-gray-700"${_scopeId}><span class="capitalize"${_scopeId}>${ssrInterpolate(patient.gender)}</span></td><td class="px-4 py-4 text-sm text-gray-700"${_scopeId}>${ssrInterpolate(patient.date_of_birth)}</td><td class="px-4 py-4 text-sm"${_scopeId}><div class="flex gap-2"${_scopeId}><button class="rounded bg-blue-100 px-3 py-1 text-xs font-medium text-blue-700 hover:bg-blue-200"${_scopeId}> Edit </button><button class="rounded bg-red-100 px-3 py-1 text-xs font-medium text-red-700 hover:bg-red-200"${_scopeId}> Delete </button></div></td></tr>`);
              });
              _push2(`<!--]--></tbody></table></div></div></div>`);
            } else {
              _push2(`<!---->`);
            ...
            if (activeTab.value === "results") {
              ...
              ssrRenderList(filteredResults.value, (result) => {
                _push2(`<tr class="hover:bg-gray-50"${_scopeId}><td class="px-4 py-4 text-sm font-medium text-gray-900"${_scopeId}>${ssrInterpolate(result.test_name)}</td><td class="px-4 py-4 text-sm text-gray-700"${_scopeId}>${ssrInterpolate(result.result_type)}</td><td class="px-4 py-4 text-sm text-gray-700"${_scopeId}>${ssrInterpolate(formatDate(result.test_date))}</td><td class="px-4 py-4 text-sm text-gray-700"${_scopeId}><span class="uppercase"${_scopeId}>${ssrInterpolate(result.files.file_type || "N/A")}</span></td><td class="px-4 py-4 text-sm"${_scopeId}><span class="${ssrRenderClass([
                  getStatusColor(
                    result.status
                  ),
                  "rounded-full px-3 py-1 text-xs font-semibold"
                          ...
                          createVNode("tbody", { class: "divide-y divide-gray-200 bg-white" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(filteredPatients.value, (patient) => {
                              return openBlock(), createBlock("tr", {
                                ...
                                createVNode("td", { class: "px-4 py-4 text-sm font-medium text-gray-900" }, toDisplayString(patient.id), 1),
                          ...
                          createVNode("tbody", { class: "divide-y divide-gray-200 bg-white" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(filteredResults.value, (result) => {
                              return openBlock(), createBlock("tr", {
                                ...
                                createVNode("td", { class: "px-4 py-4 text-sm text-gray-700" }, [
                                  createVNode("span", { class: "uppercase" }, toDisplayString(result.files.file_type || "N/A"), 1)
                                ]),
                                createVNode("td", { class: "px-4 py-4 text-sm" }, [
                                  createVNode("span", {
                                    class: [
                                ...
                                createVNode("td", { class: "px-4 py-4 text-sm" }, [
                                  result.files.file_path ? (openBlock(), createBlock("button", {
                                    key: 0,
                                    class: "rounded bg-green-100 px-3 py-1 text-xs font-medium text-green-700 hover:bg-green-200"
