        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(filteredPatients.value, (patient) => {
              _push2(`<tr class="hover:bg-gray-50"${_scopeId}><td class="px-4 py-3 font-medium text-gray-800"${_scopeId}>${ssrInterpolate(patient.name)}</td><td class="px-4 py-3 text-gray-700"${_scopeId}>${ssrInterpolate(patient.email)}</td><td class="px-4 py-3 text-gray-700"${_scopeId}>${ssrInterpolate(patient.phone)}</td><td class="px-4 py-3 text-gray-700"${_scopeId}>${ssrInterpolate(patient.gender)}</td><td class="px-4 py-3 text-gray-700"${_scopeId}>${ssrInterpolate(formatDate(patient.date_of_birth))}</td><td class="px-4 py-3 text-gray-700"${_scopeId}>${ssrInterpolate(patient.address)}</td><td class="px-4 py-3 text-center text-gray-700"${_scopeId}>${ssrInterpolate(patient.total_results)}</td><td class="px-4 py-3 text-gray-600"${_scopeId}>${ssrInterpolate(formatDate(patient.last_result_date))}</td><td class="px-4 py-3"${_scopeId}><button class="rounded bg-blue-100 px-3 py-1 text-xs font-medium text-blue-700 transition hover:bg-blue-200"${_scopeId}> View Results </button></td></tr>`);
            });
            _push2(`<!--]-->`);
            ...
            return [
              createVNode("div", { class: "h-full w-full bg-gray-100 px-10 pt-5" }, [
