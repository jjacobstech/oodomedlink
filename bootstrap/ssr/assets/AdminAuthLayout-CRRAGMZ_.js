...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "navbar fixed top-0 z-50 flex w-full items-center bg-base-100 bg-white px-4 py-3 shadow-md md:px-8 lg:px-12" }, _attrs))}><div class="flex w-full items-center justify-between">`);
      _push(ssrRenderComponent(_sfc_main$2, null, null, _parent));
      _push(`</div>`);
      if (mobileMenu.value) {
        _push(`<div class="absolute left-0 right-0 top-full z-50 border-t bg-white shadow-lg lg:hidden"><div class="flex flex-col space-y-4 p-4"><div class="focus-within:border-deepblue group flex items-center rounded-md border-2 border-transparent shadow-lg transition-colors duration-200"><div class="px-3">`);
        _push(ssrRenderComponent(unref(Magnifer), { class: "group-focus-within:text-deepblue h-5 w-auto text-gray-400 transition-colors duration-200" }, null, _parent));
