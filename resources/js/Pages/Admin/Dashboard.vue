...
const emails = ref<EmailDelivery[]>(
    props.emails || [
        {
            id: '1',
            patient_result_id: '1',
...
<template>
    ...
    <AdminAuthenticatedLayout>
        <div class="flex h-full w-full gap-1 overflow-hidden bg-gray-100">
            <!-- Main Content -->
            <div class="w-full overflow-y-auto p-6">
                    ...
                    <div class="rounded-xl bg-white p-6 shadow-sm">
                        ...
                        <div class="mb-6 grid grid-cols-1 gap-4 md:grid-cols-4">
                            ...
                            <div class="rounded-lg bg-yellow-50 p-4">
                                ...
                                <p
                                    class="mt-1 text-2xl font-bold text-yellow-600"
                                >
                                    {{
                                        emails.filter(
                                            (e) => e.status === 'pending',
                            ...
                            <div class="rounded-lg bg-orange-50 p-4">
                                ...
                                <p
                                    class="mt-1 text-2xl font-bold text-orange-600"
                                >
                                    {{
                                        emails.filter(
                                            (e) => e.status === 'bounced',
                ...
                >
                    <div
                        class="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-xl bg-white p-6"
                    >
